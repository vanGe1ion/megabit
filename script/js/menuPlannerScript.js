...
$("#db-edit").click(function () {
    ...
    $("#today, #next, #prev, .horMenu").button("disable");
...
$("#db-cancel").click(function () {
    ThrowDialog("#dialogs", "Отмена изменений", "Отменить все внесенные изменения?", function () {
        ...
        $("#today, #next, #prev, .horMenu").button("enable");
        ...
        $.get("https://isdayoff.ru/api/getdata",
            ...
            function (res) {
                switch (+res) {
                    ...
                    default:{
                        ThrowNotice("#notices", "Warning", "Предупреждение", "isDayOffAPI",
...
var MenuDeleteHandler = function (buttonSelector) {
    ...
    if(menuButtonCell.hasClass("addMark")){
        ...
        ThrowDialog("#dialogs", "Удаление", noticeText, function () {
            //pool
